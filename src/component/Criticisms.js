            ...
            <section className="container mx-auto mt-20">
                <div className="grid grid-cols-6 md:grid-cols-12 gap-1">
                    <div className="col-span-2">
                        ...
                        <div>
                            <button className={'text-2xl mt-1 mb-2' + (cur_sub_category === "all" ? "border border-b-2" : "")} onClick={() => { set_category("all") }}>All</button>
                        </div>
                        <div>
                            <button className={'text-2xl mt-1 mb-2' + (cur_sub_category === "Literature" ? "border border-b-2" : "")} onClick={() => { set_category("Literature") }}>Literature</button>
                        </div>
                        <div>
                            <button className={'text-2xl mt-1 mb-2' + (cur_sub_category === "Visual & Audio Arts" ? "border border-b-2" : "")} onClick={() => { set_category("Visual & Audio Arts") }}>{'Visual & Audio Arts'}</button>
                        </div>
                        <div >
                            <button className={'text-2xl mt-1 mb-2' + (cur_sub_category === "Recommendation" ? "border border-b-2" : "")} onClick={() => { set_category("Recommendation") }}>Recommendation</button>
                        </div>
                    </div>
