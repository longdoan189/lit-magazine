    ...
    return (
        <div>
            ...
            <div className='bg-gray-400 grid grid-cols-4'>
                <p className='text-xl py-12 mx-12 col-span-3'>
            ...
            <div className='mt-10 mx-8'>
                ...
                {Array(5).fill(1).map((el, i) =>
                    <div className=''>
                        ...
                        <h1 className='text-center text-3xl'>{"Name"+i}</h1>
                        <p className='text-center text-xl'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                    </div>
                )}
                </div>
            </div>
