...
export default function Searchbar() {
    ...
    return (
        <form onSubmit={formik.handleSubmit} className="pt-1 relative mx-auto text-gray-600">
            <input className="border-2 border-gray-300 bg-white rounded-lg text-sm focus:outline-none" type="search" name="search" onChange={formik.handleChange} />
